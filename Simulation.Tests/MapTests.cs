...
public class MapTests
{
    ...
    public void TestBoundsCheckSquareMap()
    {
        ...
        Assert.True(_positionUtility.IsInBounds(mapSpec, new(0, 0)));

        Assert.True(_positionUtility.IsInBounds(mapSpec, new(9, 9)));

        Assert.True(!_positionUtility.IsInBounds(mapSpec, new(0, 10)));

        Assert.True(!_positionUtility.IsInBounds(mapSpec, new(10, 0)));
    }
}
